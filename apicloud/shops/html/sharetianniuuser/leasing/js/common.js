...
(function() {
    var serverconfig = {
        ...
        // 'web_url': 'http://192.168.1.222:3000/client/html/',
        // 后端服务器IP
        // 'serviceIP': 'http://192.168.1.121:80/',
        'serviceIP': 'http://tianniu.weidinghuo.com/'
        // 分享页面
        'h5share_url': 'http://tianniu.weidinghuo.com/sharetianniuuser/leasing/'
    };
    ...
    GLOBALconfig.agent_api = url_api.agent; // 供货端 API 请求地址
    GLOBALconfig.h5share_url = serverconfig.h5share_url; // 分享
    ...
    GLOBALconfig.custName = window.localStorage.getItem("custName"); // 全局公司名称
    ...
    apps.axpost = function(url, param, successfn, codefn) {
        ...
        param.sharecode = GLOBALconfig.sharecode;
        setTimeout(function() {
            $.ajax({
                type: "post",
                data: param,
                ...
                crossDomain: true,
                url: GLOBALconfig.agent_api + url,
                dataType: "json",
